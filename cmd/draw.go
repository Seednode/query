...
func registerDraw(mux *httprouter.Router, usage *sync.Map, errorChannel chan<- Error) {
	...
	mux.GET("/draw/", serveUsage(module, usage, errorChannel))

	mux.GET("/draw/gif/:color/:dimensions", drawImage("GIF", errorChannel))
	mux.GET("/draw/gif/", serveUsage(module, usage, errorChannel))

	mux.GET("/draw/jpg/:color/:dimensions", drawImage("JPEG", errorChannel))
	mux.GET("/draw/jpg", serveUsage(module, usage, errorChannel))

	mux.GET("/draw/png/:color/:dimensions", drawImage("PNG", errorChannel))
	mux.GET("/draw/png/", serveUsage(module, usage, errorChannel))
